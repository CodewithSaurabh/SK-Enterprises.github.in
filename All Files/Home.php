...
<body>
    ...
    <div class="slider">
		<div class="slides">
			...
			<!-- Auto circulate the image after 4 seconds -->
		...
		<!-- javascript for the buttons conrols slider -->
		<script type="text/javascript">
			var slider_content = document.getElementByClass('slide');
