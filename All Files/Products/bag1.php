...
<html lang="en">
<head>
  	<title>DRAZO Kids School Bag Marshall Soft Plush Cartoon Baby</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/bag2.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/bag2.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag2(b).jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag2(c).jpeg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart">Add to cart</button>
                    <input type="hidden" name="item_name" value="DRAZO Kids School Bag Marshall Soft Plush Cartoon Baby">
                    <input type="hidden" name="price" value="259">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Small 10 L Backpack Kids School Bags RED</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;1,099</del></h3>
                <h2>Deal Price:	&#8377;259 <div class="rate"><del>&#8377;1,099</del>&nbsp;76% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;840 (76%)</h3>
                ...
                <ul>
                    ...
                    <li>Color - Red</li>
                    <li>Material, Waterproof - Material: Cotton, Waterproof: No</li>
                    <li>Number of Compartments - 1</li>
                    <li>Number of Pockets - 1</li>
                    <li>Capacity - 10 L</li>
                    <li>Dimensions - W x H: 5 x 10 inch</li>
                </ul>
            </div>
        </div>
    </form>
