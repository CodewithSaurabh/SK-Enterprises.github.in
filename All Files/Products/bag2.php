...
<html lang="en">
<head>
  	<title>DRAZO Kids Bag Elephant Soft Plush Backpack Plush Bag</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/bag3.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/bag3.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag3(b).jpeg" alt="product-img" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="DRAZO Kids Bag">
                    <input type="hidden" name="price" value="699">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>DRAZO Kids Bag Elephant Soft Plush Backpack Plush Bag</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;699</del></h3>
                <h2>Deal Price:	&#8377;249 <div class="rate"><del>&#8377;699</del>&nbsp;64% &nbsp;off</div></h2>
                <h2>Deal Price:	&#8377;249</h2>
                <h3>You Save:	&#8377;450 (64%)</h3>
