...
<html lang="en">
<head>
  	<title>Darzo 1004_SB Waterproof</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/bag4.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/bag4.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag4(b).jpeg" alt="product-img" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Darzo 1004_SB Waterproof">
                    <input type="hidden" name="price" value="399">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>18 inch Expandable Laptop Backpack  (Blue)</h1>
                ...
                <h2>Deal Price:	&#8377;329 <div class="rate"><del>&#8377;1,299</del>&nbsp;69% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;900 (69%)</h3>
                <p>1 Year Warranty <a href="../warranty.html" class="know-more">Know More</a></p>
                <h4>In  Stock.</h4>
                <h3 class="heading-detail">Product Detail :-</h3>
                <ul>
                    <li>Material - polyester</li>
                    <li>Sale package - 1</li>
                    ...
                    <li>Capacity - 35 L</li>
                    <li>Dimensions -  10inch 20inch 6inch</li>
                </ul>
            </div>
        </div>
    </form>
