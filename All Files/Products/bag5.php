...
<html lang="en">
<head>
  	<title>DRAZO -500 Waterproof Backpack</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/bag6.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/bag6.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag6(b).jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag6(c).jpeg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag6(d).jpeg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="DRAZO -500 Waterproof Backpack">
            ...
            <div class="col1" id="col1">
                ...
                <h2>Deal Price:	&#8377;399 <div class="rate"><del>&#8377;1,299</del>&nbsp;73% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;960 (73%)</h3>
                ...
                <ul>
                    ...
                    <li>Capacity - 25 L</li>
                    <li>No. of pocket - 4</li>
                    <li>Dimensions - W x H: 16 x 26 inch</li>
                </ul>
            </div>
        </div>
    </form>
