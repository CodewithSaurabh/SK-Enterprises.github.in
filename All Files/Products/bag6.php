...
<html lang="en">
<head>
  	<title>Wildcarft Large 40 L Backpack Colossal (Black, Orange)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/bag1.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/bag1.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/bag1(c).jpeg" alt="product-img" class="small-col">
                    </div>
                </div>
                <div  class="cart-1 ">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Wildcarft Large 40 L Backpack">
                    <input type="hidden" name="price" value="1209">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Large 40 L Backpack Colossal  (Black, Orange)</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;2,099</del></h3>
                <h2>Deal Price:	&#8377;1,209 <div class="rate"><del>&#8377;2,099</del>&nbsp;59% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;1,790 (59%)</h3>
