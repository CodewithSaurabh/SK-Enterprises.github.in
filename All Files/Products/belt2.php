...
<html lang="en">
<head>
  	<title>Men Casual Brown Canvas Belt (Brown)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/belt2.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/belt2.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/belt2(b).jpeg" alt="product-img" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Canvas Belt">
                    <input type="hidden" name="price" value="161">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Men Casual Brown Canvas Belt</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;499</del></h3>
                <h2>Deal Price:	&#8377;161 <div class="rate"><del>&#8377;499</del>&nbsp;67% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;338 (67%)</h3>
                ...
                <ul>
                    ...
                    <li>Body feature - Cotton belt with Metal buckle</li>
                    <li>Belt width - 1.5 Inch</li>
                    <li>Weight - 200g</li>
                </ul>
            </div>
        </div>
