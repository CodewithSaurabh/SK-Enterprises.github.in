...
<html lang="en">
<head>
  	<title>Men Evening Black Artificial Leather Belt</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/belt3.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/belt3.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/belt3(b).jpeg" alt="product-img" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Black Artificial Leather Belt">
                    <input type="hidden" name="price" value="359">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Men Casual, Evening, Formal, Party Black Artificial Leather Belt</h1>
                ...
                <h2>Deal Price:	&#8377;359 <div class="rate"><del>&#8377;1,499</del>&nbsp;76% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;1,140 (76%)</h3>
                ...
                <ul>
                    <li>Type - Belt</li>
                    <li>Occasion - Casual, Evening, Formal, Party</li>
                    <li>Color - Black</li>
