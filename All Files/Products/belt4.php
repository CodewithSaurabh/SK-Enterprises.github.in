...
<html lang="en">
<head>
  	<title>Boys Artificial Leather Reversible Belt</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/belt4.jpeg"  id="product-img" alt="Product image">
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Boys Artificial Leather Reversible Belt">
                    <input type="hidden" name="price" value="459">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Boys Artificial Leather Reversible Belt</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;1,200</del></h3>
                <h2>Deal Price:	&#8377;459 <div class="rate"><del>&#8377;1,200</del>&nbsp;61% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;741 (61%)</h3>
