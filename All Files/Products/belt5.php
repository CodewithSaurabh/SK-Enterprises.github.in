...
<html lang="en">
<head>
  	<title>Girls Casual, Party, Formal Brown, Black Synthetic Belt</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/belt5.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/belt5.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/belt5(b).jpeg" alt="product-img" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Black Synthetic Belt">
                    <input type="hidden" name="price" value="299">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Girls Casual, Party, Formal Brown, Black Synthetic Belt</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;599</del></h3>
                <h2>Deal Price:	&#8377;299 <div class="rate"><del>&#8377;599</del>&nbsp;49% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;300 (49%)</h3>
