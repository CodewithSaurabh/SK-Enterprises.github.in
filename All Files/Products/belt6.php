...
<html lang="en">
<head>
  	<title>Girls Casual, Party, Evening Black Artificial Leather Belt</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/belt6.jpeg"  id="product-img" alt="Product image">
                <div  class="cart-1">
            ...
            <div class="col1" id="col1">
                <h1>Girls Casual, Party, Evening Black Artificial Leather Belt</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;300</del></h3>
                <h2>Deal Price:	&#8377;150 <div class="rate"><del>&#8377;300</del>&nbsp;50% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;150 (50%)</h3>
                ...
                <ul>
                    <li>Type - Belt</li>
                    <li>Occasion - Evening, Party, Casual</li>
                    <li>Color - Black</li>
