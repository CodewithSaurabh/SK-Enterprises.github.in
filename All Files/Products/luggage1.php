...
<html lang="en">
<head>
  	<title>Small stylies trolley (navy blue)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage1.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage1.jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage1(b).jpg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Small stylies trolley (navy blue)">
                    <input type="hidden" name="price" value="2981">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Small Cabin Luggage (57 cm) - Hard Luggage - skyblue</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;8,800</del></h3>
                <h2>Deal Price:	&#8377;2,981 <div class="rate"><del>&#8377;8,800</del>&nbsp;66% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;5,819 (66%)</h3>
                ...
                <ul>
                    ...
                    <li>Body type, material - Hard Body, ABS</li>
                    <li>Capacity - 45 L</li>
                    <li>Weight - 2.5 kg</li>
                    <li>Size - 22cm 57cm 36cm</li>
                </ul>
            </div>
        </div>
    </form>
