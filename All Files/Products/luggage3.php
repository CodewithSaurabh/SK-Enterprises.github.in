...
<html lang="en">
<head>
  	<title>Medium Check-in Luggage (RED)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage3.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage3.jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage3(b).jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage3(d).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage3(e).jpg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Medium Check-in Luggage (61 cm)">
                    <input type="hidden" name="price" value="1199">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Medium Check-in Luggage (61 cm) - Suitcase Trolley / Travel / Tourist / Bag / - Red</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;2,499</del></h3>
                <h2>Deal Price:	&#8377;1,199 <div class="rate"><del>&#8377;2,499</del>&nbsp;62% &nbsp;off</div></h2>
                <h2>Deal Price:	&#8377;1,199</h2>
                <h3>You Save:	&#8377;1,300 (52%)</h3>
                ...
                <ul>
                    <li>Pattern - Solid</li>
                    <li>Locking mechanism - Number Lock</li>
                    <li>Ideal for - Men & Women</li>
                    <li>Number of wheels - 2</li>
                    <li>Water resistant - No</li>
                    <li>Body type, material - Soft Body</li>
                    <li>Capacity - 75 L</li>
                    <li>Color - Red</li>
                    <li>Weight - 3.5 kg</li>
                    <li>External Width - 41 cm</li>
                    <li>External Height - 61 cm</li>
                    <li>External Depth - 21 cm</li>
                </ul>
            </div>
        </div>
    </form>
