...
<html lang="en">
<head>
  	<title>Bazar Polyester Travel Trolley (Mahroon)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail" >
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage4.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage4.jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage4(b).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage4(c).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage4(d).jpg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Bazar Polyester Travel Trolley (Mahroon)">
                    <input type="hidden" name="price" value="1549">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Bags Bazar Polyester 24 Inch 45 L Wine Red Soft Sided Travel Trolley Luggage Suitcase</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;2,350</del></h3>
                <h2>Deal Price:	&#8377;1,549 <div class="rate"><del>&#8377;2,350</del>&nbsp;34% &nbsp;off</div></h2>
                <h2>Deal Price:	&#8377;1,549</h2>
                <h3>You Save:	&#8377;801 (34%)</h3>
                ...
                <ul>
                    <li>Dimensions: 24 inch x 16 inch x 8 Inche (LxWxH)</li>
                    <li>Capacity: 45 Litres</li>
                    <li>Number of Wheels: 4</li>
                    <li>Handle Type: Push Button Trolley</li>
                    <li>Lock Type: Number Lock;Number of compartments: 3.</li>
                </ul>
            </div>
        </div>
    </form>
