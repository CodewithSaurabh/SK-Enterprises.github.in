...
<html lang="en">
<head>
  	<title>VIP Men's and Women's Duffle Trolley Bag</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <!-- Luggage 5 -->
    <form  action="cart_manage.php" method="POST" class="prodcut-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage5.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage5.jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage5(b).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage5(c).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage5(d).jpg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
            ...
            <div class="col1" id="col1">
                <h1>VIP Blue Zip Closure Men's and Women's Duffle Trolley Bag</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;3,600</del></h3>
                <h2>Deal Price:	&#8377;1,398 <div class="rate"><del>&#8377;3,600</del>&nbsp;61% &nbsp;off</div></h2>
                <h2>Deal Price:	&#8377;1,398</h2>
                <h3>You Save:	&#8377;2202 (61%)</h3>
                ...
                <ul>
                    ...
                    <li>Dimensions (L X W X H): 54.5 X 28.5 X 30 cms</li>
                    <li>Color: Blue</li>
                </ul>
            </div>
        </div>
