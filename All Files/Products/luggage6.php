...
<html lang="en">
<head>
  	<title>Polyester Travel Daffal (Maroon)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage6.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage6.jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage6(b).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage6(c).jpg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart̄-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="VIP Blue Zip Closure Duffle Trolley Bag">
                    <input type="hidden" name="price" value="1398">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Kamiliant Kam Laka Polyester 53 cms Maroon Travel Duffle (KAM Laka WHD 52cm - Maroon)</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;2,850</del></h3>
                <h2>Deal Price:	&#8377;1,549 <div class="rate"><del>&#8377;2,850</del>&nbsp;46% &nbsp;off</div></h2>
                <h2>Deal Price:	&#8377;1,549</h2>
                <h3>You Save:	&#8377;1,301 (46%)</h3>
                ...
                <ul>
                    <li>Outer Material: Polyester, Color: Maroon
                    </li>
                    <li>Wear resistant, Water resistant
                    </li>
                    <li>Capacity: 41.5 liters; Weight: 2350 grams; Dimensions: 53 cms x 30.5 cms x 29 cms (LxWxH)</li>
                    <li>Laptop Compatibility: No</li>
                    <li>Soft grip handle</li>
                    <li>Detachable shoulder starps</li>
