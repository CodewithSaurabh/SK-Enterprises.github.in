...
<html lang="en">
<head>
  	<title>Gear MAGNUM Travel Dholki Bag (Black)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage7.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage7.jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage7(b).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage7(c).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage7(d).jpeg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Gear MAGNUM DUFFEL Travel Duffel Bag">
                    <input type="hidden" name="price" value="799">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Gear MAGNUM DUFFEL Travel Duffel Bag  (Black)</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;1,299</del></h3>
                <h2>Deal Price:	&#8377;799 <div class="rate"><del>&#8377;1,299</del>&nbsp;38% &nbsp;off</div></h2>
                <h2>Deal Price:	&#8377;799</h2>
                <h3>You Save:	&#8377;500 (38%)</h3>
                ...
                <ul>
                    <li>Type - Travel Duffel Bag
                    </li>
                    <li>Capacity - 40 L</li>
                    <li>Material - Polyester</li>
                    <li>Color - Black</li>
                    <li>Dimensions - L x B x D: 54 cm x 29.5 cm x 25 cm</li>
                    <li>Generic Name - Duffel Bag</li>
                    <li>Weight - 250 g</li>
                </ul>
            </div>
        </div>
