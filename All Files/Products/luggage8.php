...
<html lang="en">
<head>
  	<title>Gear NEW MAXIS Travel Bag (Grey)</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail" >
        <div class="row1">
            <div class="col1">
                <img src="../images/luggage8.jpg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/luggage8.jpg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage8(b).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage8(c).jpg" alt="Product image" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/luggage8(d).jpg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Gear STATEMENT MAXIS DUFFEL Gym Bag">
                    <input type="hidden" name="price" value="599">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Gear STATEMENT MAXIS DUFFEL Gym Bag  (Black)</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;1,599</del></h3>
                <h2>Deal Price:	&#8377;599 <div class="rate"><del>&#8377;1,599</del>&nbsp;62% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;1000 (62%)</h3>
                ...
                <ul>
                    ...
                    <li>Capacity - 34 L</li>
                    <li>Cabin Size - Yes</li>
                    <li>Material - Polyester</li>
                    <li>Color - Black</li>
                    <li>Expandable Feature -No</li>
                    <li>Number of Compartments - 1</li>  
                    <li>Number of Wheels and Pockets - No. of Wheels: 0</li>
                    <li>Dimensions - L x B x D: 50 cm x 26 cm x 26 cm</li>
                    <li>Weight - 440 g</li>
                </ul>
            </div>
        </div>
