...
<html lang="en">
<head>
  	<title>Casual Black Clutch</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/purse3.jpeg"  id="product-img" alt="Product image">
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Casual Black Clutch">
                    <input type="hidden" name="price" value="224">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Casual, Formal, Party Black, Beige Clutch</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;899</del></h3>
                <h2>Deal Price:	&#8377;224 <div class="rate"><del>&#8377;899</del>&nbsp;75% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;675 (75%)</h3>
                <p>1 Year Warranty for Purse <a href="../warranty.php" class="know-more">Know More</a></p>
                <h4>In  Stock.</h4>
                <p>Buy two 2 and get Free Shipping</p>
                <h3 class="heading-detail">Product Detail :-</h3>
                <ul>
                    <li>Pattern - Clutch</li>
                    <li>Closure - zip</li>
                    <li>Ideal for - Women</li>
                    <li>Number of card slot - 2</li>
                    <li>Pattern - printed</li>
                    <li>Sales package - Pack of 2 Party Wear Clutches For Women/Girls</li>
                    <li>No. of Compartment - 2</li>
