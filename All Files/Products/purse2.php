...
<html lang="en">
<head>
  	<title>Party, Formal, Casual, Sports Blue Clutch</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/purse2.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/purse2.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/purse2(b).jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/purse2(c).jpeg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Party, Formal, Casual, Sports Blue Clutch">
                    <input type="hidden" name="price" value="389">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Party, Formal, Casual, Sports Blue Clutch</h1>
                ...
                <h2>Deal Price:	&#8377;389 <div class="rate"><del>&#8377;1,499</del>&nbsp;74% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;1,110 (74%)</h3>
                ...
                <ul>
                    <li>Type - Clutch Purse Wallet handbag</li>
                    <li>Size in Number - 8.6inch</li>
                    <li>Number of card slot - 4</li>
                    <li>Closure - twist lock</li>
                    <li>Sales package - 1</li>
                </ul>
            </div>
        </div>
    </form>
