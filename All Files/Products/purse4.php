...
<html lang="en">
<head>
  	<title>Men Black Genuine Leather Wallet</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/purse4.jpeg"  id="product-img" alt="Product image">
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Men Black Genuine Leather Wallet">
                    <input type="hidden" name="price" value="805">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Men Black Genuine Leather Wallet  (3 Card Slots)</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;895</del></h3>
                <h2>Deal Price:	&#8377;805 <div class="rate"><del>&#8377;895</del>&nbsp;10% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;90 (10%)</h3>
