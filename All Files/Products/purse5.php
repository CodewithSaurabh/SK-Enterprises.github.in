...
<html lang="en">
<head>
  	<title>Men Green Messenger Bag</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <form  action="cart_manage.php" method="POST" class="product-detail">
        <div class="row1">
            <div class="col1">
                <img src="../images/purse5.jpeg"  id="product-img" alt="Product image">
                <div class="small-product-img">
                    <div class="small-col-img">
                        <img src="../images/purse5.jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/purse5(b).jpeg" alt="product-img" class="small-col">
                    </div>
                    <div class="small-col-img">
                        <img src="../images/purse5(c).jpeg" alt="Product image" class="small-col">
                    </div>
                </div>
                <div  class="cart-1">
                    <button  name="cart"  >Add to cart</button>
                    <input type="hidden" name="item_name" value="Men Green Messenger Bag">
                    <input type="hidden" name="price" value="2531">
                    <a href="../payment.php">Buy now</a>
                </div>
            </div>
            <div class="col1" id="col1">
                <h1>Men Green Messenger Bag</h1>
                ...
                <hr>
                <h3>M.R.P.:&nbsp; <del> &#8377;3,499</del></h3>
                <h2>Deal Price:	&#8377;2,531 <div class="rate"><del>&#8377;3,499</del>&nbsp;27% &nbsp;off</div></h2>
                <h3>You Save:	&#8377;968 (27%)</h3>
