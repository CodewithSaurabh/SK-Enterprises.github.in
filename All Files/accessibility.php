...
<body>
    ...
    <div class="accessiblility">
        <h1>Accessibility Statement</h1>
        <p>S.K Enterprises is committed to providing a web site that is accessible to the widest possible audience, regardless of 
            technology or ability. We aim to comply with all applicable standards, including WCAG 2.0 accessibility standards up to 
            level AA.
        </p>
        <p>If you experience any difficulty in accessing any part of this web site, please contact us by email:
            <a href="mailto:sk0008861@gmail.com"> sk0008861@gmail.com</a> or by messaging into our 24 hour Chat Support to help assist.
        </p>
    </div>
