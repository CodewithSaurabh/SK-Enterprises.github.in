...
<body>
    ...
    <!-- Bags -->
    <h2 class="headingproduct">Bag</h2>
    <div class="mainproduct2">
        <div class="prow1">
            <div class="pcol2">
                <a href="products/bag1.php">
                    <img src="images/bag2.jpeg" alt="Bags">
                    <h4>DRAZO Kids School Bag Marshall Soft Plush Cartoon Baby </h4>
                </a>
                <div class="rating">
                ...
                <p>&#x20B9;&nbsp;259 <small><del> &#8377;1,099</del></small><div class="off"> 76% off</div></p>
            </div>
            <div class="pcol2">
                <a href="products/bag2.php">
                    <img src="images/bag3.jpeg" alt="Bags">
                    <h4>DRAZO Kids Bag Elephant Soft Plush Backpack Plush Bag</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;249 <small><del> &#8377;699</del></small><div class="off"> 64% off</div></p>
            </div>
            <div class="pcol2">
                <a href="products/bag3.php">
                    <img src="images/bag4.jpeg" alt="Bags">
                    <h4>DRAZO 1004_SB Waterproof School Bag</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;329 <small><del> &#8377;1,299</del></small><div class="off"> 74% off</div></p>
            </div>
            <div class="pcol2">
                <a href="products/bag4.php">
                    <img src="images/bag5.jpeg" alt="Bags">
                    <h4>DRAZO 1008 NAZZES SB Waterproof School Bag</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;319 <small><del> &#8377;999</del></small><div class="off"> 68% off</div></p>
            </div>
            <div class="pcol2">
                <a href="products/bag5.php">
                    <img src="images/bag6.jpeg" alt="Bags">
                    <h4>DRAZO -500 Waterproof Backpack</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;339 <small><del> &#8377;1299</del></small><div class="off"> 73% off</div></p>
            </div>
            <div class="pcol2">
                <a href="products/bag6.php">
                    <img src="images/bag1.jpeg" alt="Bags">
                    <h4>Wildcarft Large 40 L Backpack Colossal  (Black, Orange)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;1,209 <small><del> &#8377;2,999</del></small><div class="off"> 59% off</div></p>
            </div>
        </div>
    </div>
