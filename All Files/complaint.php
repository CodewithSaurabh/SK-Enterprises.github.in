...
<html lang="en">
<head>
  	<title>Complaince information</title>
  	<meta charset="utf-8">
...
<body>
    ...
    <!-- Complaince information page -->
    <div class="mainofcomplaint">
        <div class="complaint-font">Brand Name</div> : S.K Enterprises<br>
        <div class="complaint-font">Country of Origin</div> : India, Delhi <br>
        <div class="complaint-font">Manufacturers/importers name and address</div> : Z-127, Gali no. - 9, Naryan vihar Near Devender Public, Kirari 
        Suleman Nager<br>
        <div class="complaint-font">Contact info</div> : <a href="mailto:sk0008861@gmail.com">sk0008861@gmail.com</a>  , 7217676540
    </div>
