...
<body>
    ...
    <div class="contactmain">
        ...
        <form action="contactPHP.php" method="POST" name="myform" >
            <div class="firstrow">
                <select name="State" id="State" class="contactselect">
                ...
                <input type="text" name="name" maxlength="50" minlength="3" placeholder="Your name *" required>
            </div>

            <div class="firstrow">
                <input type="email" name="email" id="mail" placeholder="Your Email *" required>
                <input type="tel" placeholder="Phone no." id="phone" name="phone" minlength="10" maxlength="13" required>
            </div>

            <textarea name="message" id="textarea" cols="30" rows="7" placeholder="Your message..." required></textarea>
        ...
        <div class="contactinfo">
            <div class="add" style="margin-left: 0;">
                ...
                <strong>Saurabh trad. Pvt. Ltd </strong>
                <h3>Z-127, Gali no. - 9,10,Naryan vihar Near Devender Public,Prem nagar Kirari Suleman Nager, Delhi-86</h3>
            </div>
            <div class="add">
            ...
            <div class="add">
                ...
                <h1>Email</h1>
                <a href="email:sk0008861@gmail.com">sk0008861@gmail.com</a>
            </div>
        </div>
    </div>
