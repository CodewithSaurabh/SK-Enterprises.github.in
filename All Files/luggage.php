...
<body>
    ...
    <!-- Luggage page -->
    <h2 class="headingproduct">Luggage</h2>
    <div class="mainproduct">
        <div class="prow1">
            <div class="pcol1">
                <a href="products/luggage1.php">
                    <img src="images/luggage1.jpg" alt="luggage">
                    <h4>Small stylies trolley (navy blue)</h4>
                </a>
                <div class="rating">
                ...
                <p>&#x20B9;&nbsp;2,981 <small><del> &#8377;8,800</del></small><div class="off"> 66% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage2.php">
                    <img src="images/luggage2.jpg" alt="luggage">
                    <h4>Stylies Leather Trolley (Brown)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;6,480 <small><del> &#8377;9,000</del></small><div class="off"> 28% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage3.php">
                    <img src="images/luggage3.jpg" alt="luggage">
                    <h4>Medium Check-in Luggage (RED)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;1,199 <small><del> &#8377;2,499</del></small><div class="off"> 52% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage4.php">
                    <img src="images/luggage4.jpg" alt="luggage">
                    <h4>Bazar Polyester Travel Trolley (Mahroon)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;1,549 <small><del> &#8377;2,350</del></small><div class="off"> 34% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage5.php">
                    <img src="images/luggage5(c).jpg" alt="luggage">
                    <h4>VIP Men's and Women's Duffle Trolley Bag</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;1,398 <small><del> &#8377;3,600</del></small><div class="off"> 61% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage6.php">
                    <img src="images/luggage6.jpg" alt="luggage">
                    <h4>Polyester Travel Daffal (Maroon)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;1,549 <small><del> &#8377;2,850</del></small><div class="off"> 46% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage7.php">
                    <img src="images/luggage7.jpg" alt="luggage">
                    <h4>Gear MAGNUM Travel Dholki Bag  (Black)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;7,99 <small><del> &#8377;1,299</del></small><div class="off"> 38% off</div></p>
            </div>
            <div class="pcol1">
                <a href="Products/luggage8.php">
                    <img src="images/luggage8.jpg" alt="luggage">
                    <h4>Gear NEW MAXIS Travel Bag (Grey)</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                ...
                <p>&#x20B9;&nbsp;5,99 <small><del> &#8377;1,599</del></small><div class="off"> 62% off</div></p>
            </div>
        </div>
    </div>
