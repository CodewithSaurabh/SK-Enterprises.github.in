...
<body>
    ...
    <!-- social complaince -->
    <div class="socialcomplaince">
        <h1>Social Complaince</h1>
        <p>S.K Enterprises works to ensure that its supply chain reflects its values as a company. S.K Enterprises expects its 
            suppliers to treat their workers fairly, to provide them with a safe and healthy work environment and to protect 
            environmental quality.</p>
        <p>Through its Social Compliance Program (SCP) and its agreements with suppliers, Saurbah traders seeks to prevent all 
            instances of child labor, forced labor and human trafficking and to ensure compliance with all local laws.</p>
        <p>S.K Enterprises conducts unannounced, on-site audits of suppliers and retains independent third parties to do so as well.
            S.K Enterprises encourages open communication with its factory representatives and employees on environmental, health, 
            safety and social issues and maintains accountability standards to address and correct instances on non-compliance.</p>
    </div>
